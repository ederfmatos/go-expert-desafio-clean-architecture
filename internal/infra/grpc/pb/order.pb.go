...
type ListOrdersResponse struct {
	...
	Orders []*ListOrdersItem `protobuf:"bytes,1,rep,name=orders,proto3" json:"orders,omitempty"`
}
...
func (x *ListOrdersResponse) GetOrders() []*ListOrdersItem {
	if x != nil {
		return x.Orders
	}
	return nil
...
func (x *ListOrdersItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListOrdersItem) ProtoMessage() {}

func (x *ListOrdersItem) ProtoReflect() protoreflect.Message {
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListOrdersItem.ProtoReflect.Descriptor instead.
func (*ListOrdersItem) Descriptor() ([]byte, []int) {
	return file_internal_infra_grpc_protofiles_order_proto_rawDescGZIP(), []int{4}
}

func (x *ListOrdersItem) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListOrdersItem) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *ListOrdersItem) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *ListOrdersItem) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x40, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	...
	0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x49, 0x74, 0x65,
	0x6d, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x22, 0x69, 0x0a, 0x0e, 0x4c, 0x69, 0x73,
	0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x72, 0x69, 0x63, 0x65, 0x32, 0x81, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x73, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x16,
	0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x18, 0x5a, 0x16, 0x69, 0x6e, 0x74, 0x65,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*ListOrdersItem)(nil),      // 4: pb.ListOrdersItem
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	4, // 0: pb.ListOrdersResponse.orders:type_name -> pb.ListOrdersItem
